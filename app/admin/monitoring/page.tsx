  ...
  return (
    ...
    >
       ...
       <div className="p-4 border-t border-slate-100 bg-white flex flex-col gap-2">
          <div className={`flex items-center justify-between text-[9px] font-bold uppercase tracking-widest p-2 rounded-lg border ${isDeviceLocked ? 'bg-blue-50/50 border-blue-100 text-blue-600' : 'bg-slate-50 border-slate-100 text-slate-400'}`}>
...
export default function MonitoringPage() {
  ...
  if (loading) {
    return <div className="py-20 flex justify-center"><LoaderCircle className="w-10 h-10 text-blue-500 animate-spin" /></div>;
  }
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 p-4 md:p-8 max-w-7xl mx-auto text-slate-900 relative">
         ...
         <div className="fixed inset-0 z-[300] bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in">
            <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl border border-slate-200 overflow-hidden animate-in zoom-in-95 duration-200">
               <div className="p-6 md:p-8 border-b border-slate-100 bg-slate-50 flex justify-between items-center">
                  <h2 className="text-xl font-black text-slate-800 flex items-center gap-3"><Radio className="w-6 h-6 text-blue-600"/> Siarkan Pengumuman</h2>
               ...
               <div className="p-6 md:p-8 space-y-6">
                  <div>
                     ...
                     <div className="relative">
                       <select value={broadcastTarget} onChange={(e) => setBroadcastTarget(e.target.value)} className="w-full bg-white border border-slate-200 rounded-xl px-4 py-3.5 text-sm font-bold text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none appearance-none cursor-pointer shadow-sm">
                  ...
                  {broadcastTarget === 'room' && (
                     <div className="animate-in fade-in slide-in-from-top-2 relative">
                        <select value={broadcastTargetId} onChange={(e) => setBroadcastTargetId(e.target.value)} className="w-full bg-blue-50/50 border border-blue-200 rounded-xl px-4 py-3.5 text-sm font-bold text-blue-700 focus:ring-2 focus:ring-blue-500 outline-none appearance-none cursor-pointer">
                  ...
                  <div>
                     ...
                     <textarea value={broadcastText} onChange={(e) => setBroadcastText(e.target.value)} rows={4} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3.5 text-sm font-medium text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none resize-none placeholder:text-slate-400 shadow-inner" placeholder="Ketik pesan yang akan dimunculkan secara paksa di layar siswa..."></textarea>
                  </div>
               </div>
               <div className="p-6 md:p-8 border-t border-slate-100 bg-slate-50 flex gap-3">
                  ...
                  <button onClick={executeBroadcast} disabled={!broadcastText || (broadcastTarget === 'room' && !broadcastTargetId)} className="flex-1 py-3.5 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 shadow-md shadow-blue-200 disabled:bg-slate-300 disabled:shadow-none flex items-center justify-center gap-2 active:scale-95 transition-all"><Send className="w-4 h-4"/> Siarkan Pesan</button>
               </div>
            </div>
         </div>
      )}
              ...
              <div className="p-5 md:p-8 border-b border-slate-100 bg-slate-50/80 flex justify-between items-center shrink-0">
                 <div className="flex items-center gap-5">
                    {detailStudentObj.avatar_url ? (
                       ...
                       <div className="w-14 h-14 rounded-2xl bg-blue-100 flex items-center justify-center text-blue-600 border border-blue-200 shadow-sm"><UserCircle2 className="w-7 h-7"/></div>
                    )}
                    <div>
                       <h2 className="text-xl md:text-2xl font-black text-slate-800 flex items-center gap-3">
                          ...
                          {detailIsBlockedBySystem ? (
                             ...
                             <span className="text-[10px] bg-blue-100 text-blue-700 px-2.5 py-1 rounded-md border border-blue-200 font-black animate-pulse tracking-widest uppercase">AKTIF MENGERJAKAN</span>
                          )}
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-slate-50/50">
                 ...
                 <div className="space-y-6">
                    ...
                    <div className="bg-white border border-slate-200 rounded-[1.5rem] p-6 shadow-sm">
                       <h3 className="text-xs font-black text-slate-500 uppercase tracking-widest mb-5 flex items-center gap-2"><Server className="w-4 h-4 text-blue-500"/> Identitas Perangkat Peserta</h3>
                       <div className="space-y-4 text-sm">
                          <div className="flex flex-col border-b border-slate-100 pb-3">
                             ...
                             <span className="font-mono font-black text-blue-700 text-base">{modalIp}</span>
                          </div>
                          <div className="flex flex-col border-b border-slate-100 pb-3">
                             ...
                             return (
                                <div key={opt.key} className="flex items-center justify-between p-3.5 rounded-xl bg-slate-50 border border-slate-200 shadow-sm">
                                   <div className="flex items-center gap-3">
                                      <Icon className={`w-4 h-4 ${!isBypassed ? 'text-blue-600' : 'text-slate-400'}`}/>
                                   ...
                                   <button 
                                      ...
                                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${!isBypassed ? 'bg-blue-600 shadow-inner' : 'bg-slate-300'}`}
                                   >
                    ...
                    <div className="bg-white border border-slate-200 rounded-[1.5rem] p-6 shadow-sm">
                       ...
                       <div className="space-y-4">
                          <button onClick={() => triggerResetDevice(detailSessionObj.id, detailStudentObj.full_name)} className="w-full flex items-center justify-between p-4 bg-white hover:bg-blue-50 border border-slate-200 hover:border-blue-300 rounded-xl transition-all shadow-sm group">
                             <div className="flex items-center gap-3 text-left">
                                <div className="p-2 bg-blue-100 text-blue-600 rounded-lg group-hover:bg-blue-600 group-hover:text-white transition-colors"><Smartphone className="w-4 h-4"/></div>
                                <div>
                                   <p className="text-sm font-black text-slate-800 group-hover:text-blue-700 transition-colors">Reset Kunci Perangkat</p>
                    ...
                    <div className="bg-white border border-slate-200 rounded-[1.5rem] p-6 shadow-sm">
                       <h3 className="text-xs font-black text-blue-600 uppercase tracking-widest mb-4 flex items-center gap-2"><MessageSquare className="w-4 h-4"/> Pesan Personal Screen</h3>
                       <div className="flex flex-col gap-3">
                          <textarea value={dmText} onChange={e => setDmText(e.target.value)} rows={3} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-800 focus:border-blue-500 focus:ring-2 focus:bg-white outline-none resize-none placeholder-slate-400 shadow-inner" placeholder={`Ketik pesan untuk ${detailStudentObj.full_name}...`}></textarea>
                          <button onClick={() => sendDirectMessage(detailStudentObj.id, detailStudentObj.full_name)} disabled={!dmText.trim()} className="w-full py-3.5 bg-blue-600 text-white font-bold text-sm rounded-xl hover:bg-blue-700 transition-all disabled:bg-slate-300 disabled:shadow-none shadow-md shadow-blue-200 flex justify-center items-center gap-2 active:scale-95"><Send className="w-4 h-4"/> Kirim Pesan</button>
                       </div>
                    </div>
                 ...
                 <div className="lg:col-span-2 space-y-6 md:space-y-8">
                    ...
                    <div className="bg-white border border-slate-200 rounded-[1.5rem] p-6 md:p-8 shadow-sm">
                       <div className="flex justify-between items-center mb-5 pb-5 border-b border-slate-100">
                          ...
                          {locationLog && (
                             <a href={`http://googleusercontent.com/maps.google.com/maps?q=${locationLog.snapshot_url.split(',')[0]},${locationLog.snapshot_url.split(',')[1]}`} target="_blank" rel="noreferrer" className="text-[10px] font-black uppercase tracking-widest text-blue-700 bg-blue-50 hover:bg-blue-100 border border-blue-200 px-3 py-2 rounded-lg flex items-center gap-1.5 transition-colors shadow-sm">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-6 md:p-8 rounded-[2.5rem] border border-blue-100 shadow-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          <h1 className="text-3xl md:text-4xl font-black text-slate-800 flex items-center gap-4 tracking-tight">
            <div className="p-3 bg-blue-50 text-blue-600 rounded-2xl border border-blue-100 shadow-inner"><MonitorPlay className="w-8 h-8" /></div>
            Live Proctoring
          </h1>
          <p className="text-slate-500 text-sm mt-3 font-bold max-w-xl leading-relaxed">Pantau aktivitas layar, waktu, kamera, dan progres siswa secara <i>Real-Time</i> selama ujian berlangsung.</p>
        </div>

        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto relative z-10">
          <button onClick={() => setIsBroadcastOpen(true)} className="w-full sm:w-auto px-6 py-4 bg-indigo-50 text-indigo-700 hover:bg-indigo-600 hover:text-white font-black rounded-2xl border border-indigo-200 hover:border-indigo-600 transition-all shadow-sm flex items-center justify-center gap-2 active:scale-95">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
             <div className="relative flex-1 sm:w-80">
                <select 
                   ...
                   className="w-full bg-white border border-slate-200 rounded-2xl px-5 py-4 text-sm font-black text-slate-800 focus:ring-2 focus:ring-blue-500 outline-none appearance-none cursor-pointer shadow-sm transition-all hover:border-blue-300"
                >
                ...
                <ChevronDown className="absolute right-5 top-1/2 -translate-y-1/2 w-5 h-5 text-blue-500 pointer-events-none font-bold" />
             </div>
             <button onClick={() => fetchMonitoringData(selectedExamId)} disabled={refreshing} className="p-4 bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white rounded-2xl border border-blue-200 hover:border-blue-600 transition-all shadow-sm shrink-0 active:scale-95" title="Segarkan Data Manual">
      ...
      {/* FITUR BARU: FILTERING LANJUTAN ELEGANT */}
      <div className="bg-white p-3 rounded-[1.5rem] border border-slate-200 shadow-sm flex flex-col md:flex-row items-center gap-3 w-full">
         <div className="relative w-full md:flex-1">
            ...
            <input 
              ...
              className="w-full bg-slate-50 border-none rounded-xl pl-11 pr-4 py-3 text-sm font-bold text-slate-800 focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition-all placeholder-slate-400" 
            />
         </div>
         <div className="w-px h-8 bg-slate-200 hidden md:block mx-1"></div>
         <div className="flex w-full md:w-auto gap-2">
            <select value={filterType} onChange={(e) => { setFilterType(e.target.value as any); setFilterValue(''); }} className="flex-1 md:w-40 bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-slate-700 outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer appearance-none transition-all hover:bg-white">
              <option value="all">Semua Peserta</option>
              <option value="class">Filter Kelas</option>
              <option value="room">Filter Ruangan</option>
            </select>
            {filterType === 'class' && (
               <select value={filterValue} onChange={(e) => setFilterValue(e.target.value)} className="flex-1 md:w-48 bg-white border border-blue-200 rounded-xl px-4 py-3 text-sm font-black text-blue-700 outline-none focus:ring-2 focus:ring-blue-500 cursor-pointer appearance-none shadow-sm animate-in fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
         ...
         <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-blue-200 shadow-[0_0_20px_rgba(59,130,246,0.15)] flex items-center gap-5 transform hover:-translate-y-1 transition-all duration-300">
            <div className="w-14 h-14 bg-blue-500 rounded-2xl flex items-center justify-center border border-blue-400 shrink-0 relative shadow-inner">
               <span className="absolute -top-1 -right-1 flex h-4 w-4"><span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-blue-300 opacity-75"></span><span className="relative inline-flex rounded-full h-4 w-4 bg-blue-400 border border-white"></span></span>
               <Activity className="w-7 h-7 text-white"/>
            </div>
            <div><p className="text-[10px] font-black text-blue-500 uppercase tracking-widest mb-1">Sedang Mengerjakan</p><p className="text-3xl font-black text-blue-700">{pesertaAktif}</p></div>
         </div>
         <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-slate-200 shadow-sm flex items-center gap-5 hover:shadow-md transition-shadow">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
         {filteredSessions.length === 0 ? (
            <div className="col-span-full py-24 text-center bg-white border border-slate-200 border-dashed rounded-[2.5rem] shadow-sm">
               ...
               <h3 className="text-2xl font-black text-slate-700 mb-2">Tidak Ada Data Sesuai Filter</h3>
               <p className="text-slate-500 font-medium text-sm">Peserta belum ada yang masuk atau coba ubah kata kunci filter Anda.</p>
            </div>
         ) : (
